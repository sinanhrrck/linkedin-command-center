...
export const STAGE_DEF: Record<Stage, StageDef> = {
  ...
  bedarf:      { ziel: "Bedarf kurz spiegeln und das PASSENDE kostenlose Angebot als konkrete Hilfe ins Spiel bringen. Nicht weiter ausfragen.", erlaubt: ["spiegeln", "validieren", "story_teilen", "leichter_next_step"], verboten: ["nummer_fragen"], exit: ["Bedarf gespiegelt & offen → vertrauen/call_angebot", "Einwand → einwand"] },
  ...
  call_angebot:{ ziel: "Das PASSENDE kostenlose Angebot als echte Hilfe anbieten (siehe \"Welches Angebot?\": Karriere-Signal → Karriere-Angebot, Geldfragen → Gespräch zu den Geldfragen) – erst der Nutzen für die Person, dann EIN konkreter nächster Schritt mit Terminvorschlag. Locker, kein Druck, kein Skript.", erlaubt: ["call_anbieten", "leichter_next_step", "validieren"], verboten: ["nummer_fragen"], exit: ["Person sagt zu / fragt nach dem Wie → nummer (Übergabe)", "zögert → zurück in vertrauen", "Einwand → einwand"] },
  nummer:      { ziel: "Zusage festhalten und an den Menschen übergeben – wie es weitergeht, steht beim gewählten Angebot unter Ablauf/nächster Schritt. Der Bot schließt nicht selbst ab.", erlaubt: ["leichter_next_step", "validieren", "eskalieren"], verboten: [], exit: ["Zusage/Interesse → Übergabe an den Menschen"] },
  termin:      { ziel: "Übergabe an den Menschen bestätigen (Termin bzw. nächster Schritt des gewählten Angebots).", erlaubt: ["termin_bestaetigen", "eskalieren"], verboten: [], exit: ["Übergabe steht → abgeschlossen"] },
