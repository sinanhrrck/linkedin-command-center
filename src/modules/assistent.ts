...
- Heute: Arbeitskorb nach Wirkung sortiert. Oben "Warum steht etwas still" (Blockaden mit Knopf zum Beheben), dann "Was noch rausgeht" (Warteschlange je Kanal: Nachrichten und Vernetzungsanfragen, mit Status, Grund, nächstem Versuch, Tageslimit, den nächsten fünf Kontakten), dann "Bot-Aktivität" (Jetzt, Danach, Zuletzt erledigt). Knopf "Schnellprüfung": alle offenen Entwürfe als Liste mit Häkchen, mehrere auf einmal genehmigen. Grünes "geprüft" heißt: besteht die automatische Textprüfung.
...
- Kontakte: eine Liste aller Kontakte wie in einem CRM, sortierbar. Je Kontakt: Verlauf, Stufe von Hand setzen (nur qualifiziert, Termin, gewonnen, verloren, passt nicht), Aufgaben, Notizen, pausieren.
- Auswertung: "Von der Quelle zum Ergebnis" (Funnel mit Filtern), Tages-/Wochenbericht, "Was wirkt" (welcher Nachrichtenstil mehr positive Antworten bringt), Lernen aus deinen Entscheidungen.
